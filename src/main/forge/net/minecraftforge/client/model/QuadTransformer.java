...
public class QuadTransformer
{
    ...
    private static int findPositionOffset(VertexFormat fmt)
    {
        ...
        return fmt.getElementOffset(index);
    }
    ...
    public BakedQuad processOne(BakedQuad input)
    {
        ...
        return new BakedQuad(outData, input.getColorIndex(), input.getFace(), input.getSprite(), input.shouldApplyDiffuseLighting(), format);
    }
    ...
    public List<BakedQuad> processMany(List<BakedQuad> inputs)
    {
        ...
        for(BakedQuad input : inputs)
        {
            ...
            outputs.add(new BakedQuad(outData, input.getColorIndex(), input.getFace(), input.getSprite(), input.shouldApplyDiffuseLighting(), format));
        }
        return outputs;
    }
