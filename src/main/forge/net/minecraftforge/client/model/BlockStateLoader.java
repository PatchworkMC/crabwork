...
public class BlockStateLoader
{
                    ...
                    {   // Convert Version1 variants into vanilla variants for the ModelBlockDefinition.
                        ...
                        for (ForgeBlockStateV1.Variant var : entry.getValue())
                        {
                            ...
                            if (!var.isVanillaCompatible() && bakery != null)
                            {
                                ...
                                UnbakedModel model = ForgeVariantHelper.prepareInjectedModel(modelLocation, var.getModel(), var.getSmooth(), var.getGui3d(), var.getTextures(), var.getOnlyPartsVariant(), var.getCustomData());
    ...
    public static class SubModel
    {
        ...
        @Nullable
        public Identifier getModelLocation() { return model; }
    ...
    {
        public static UnbakedModel prepareInjectedModel(Identifier blockstateLocation, @Nullable Identifier modelLocation, Optional<Boolean> smooth, Optional<Boolean> gui3d, ImmutableMap<String, String> textures, ImmutableMap<String, SubModel> parts, ImmutableMap<String, String> customData)
        {
            int size = parts.size();
