...
public class MaterialLibrary2
{
    public static final MaterialLibrary2 EMPTY = new MaterialLibrary2();
    final Map<String, Material> materials = Maps.newHashMap();

    private MaterialLibrary2()
    {
    }

    public MaterialLibrary2(LineReader reader) throws IOException
    {
        ...
        while((line = reader.readAndSplitLine(true)) != null)
        {
            switch(line[0])
            {
                ...
                case "Ka":
                    currentMaterial.ambientColor = OBJModel2.parseVector4(line);
                    break;
                ...
                case "Kd":
                    currentMaterial.diffuseColor = OBJModel2.parseVector4(line);
                    break;
                ...
                case "Ks":
                    currentMaterial.specularColor = OBJModel2.parseVector4(line);
                    break;
