...
public class OBJLoader2 implements IModelLoader<OBJModel2>
{
    ...
    private final Map<Identifier, MaterialLibrary2> materialCache = Maps.newHashMap();
    ...
    public OBJModel2 read(JsonDeserializationContext deserializationContext, JsonObject modelContents)
    {
        ...
        return loadModel(new OBJModel2.ModelSettings(new Identifier(modelLocation), detectCullableFaces, diffuseLighting, flipV, ambientToFullbright, materialLibraryOverrideLocation));
    }
    ...
    public MaterialLibrary2 loadMaterialLibrary(Identifier materialLocation)
    {
