...
public enum B3DLoader implements ICustomModelLoader
{
    ...
    private static final class ModelWrapper implements UnbakedModel
    {
        ...
        public ModelWrapper(Identifier modelLocation, B3DModel model, ImmutableSet<String> meshes, boolean smooth, boolean gui3d, int defaultKey, ImmutableMap<String, String> textures)
        {
        ...
        {
            return textures.values().stream().filter(loc -> !loc.startsWith("#")).map(Identifier::new).collect(Collectors.toList());
        }
        ...
        public BakedModel bake(net.minecraft.client.render.model.ModelLoader bakery, Function<Identifier, Sprite> spriteGetter, ModelBakeSettings sprite, VertexFormat format)
        {
            ...
            for(Map.Entry<String, String> e : textures.entrySet())
            {
                ...
                {
                    builder.put(e.getKey(), spriteGetter.apply(new Identifier(e.getValue())));
                }
            }
        ...
        private final void putVertexData(UnpackedBakedQuad.Builder builder, Vertex v, Vector3f faceNormal, Sprite sprite)
        {
            ...
            for(int e = 0; e < format.getElementCount(); e++)
            {
                ...
                case UV:
                    ...
                    {
                        builder.put(e,
                            sprite.getFrameU(v.getTexCoords()[0].x * 16),
                            sprite.getFrameV(v.getTexCoords()[0].y * 16),
                            0,
                            1
                        );
                    }
