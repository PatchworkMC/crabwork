...
public class ForgeBlockModelRenderer extends BlockModelRenderer
{
    ...
    @Override
    public boolean renderModelFlat(BlockRenderView world, BakedModel model, BlockState state, BlockPos pos, BufferBuilder buffer, boolean checkSides, Random rand, long seed, IModelData modelData)
    {
    ...
    @Override
    public boolean renderModelSmooth(BlockRenderView world, BakedModel model, BlockState state, BlockPos pos, BufferBuilder buffer, boolean checkSides, Random rand, long seed, IModelData modelData)
    {
        if(ForgeConfig.CLIENT.forgeLightPipelineEnabled.get())
        {
    ...
    public static boolean render(VertexLighterFlat lighter, BlockRenderView world, BakedModel model, BlockState state, BlockPos pos, BufferBuilder wr, boolean checkSides, Random rand, long seed, IModelData modelData)
    {
