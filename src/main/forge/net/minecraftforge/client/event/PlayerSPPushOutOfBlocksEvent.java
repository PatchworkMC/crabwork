...
public class PlayerSPPushOutOfBlocksEvent extends PlayerEvent
{
    ...
    public Box getEntityBoundingBox() { return entityBoundingBox; }
    public void setEntityBoundingBox(@Nonnull Box entityBoundingBox) { this.entityBoundingBox = entityBoundingBox; }
}
