...
import net.minecraftforge.fml.client.gui.GuiSlotModList.ModEntry;
...
public class GuiSlotModList extends AlwaysSelectedEntryListWidget<GuiSlotModList.ModEntry>
{
    ...
    class ModEntry extends AlwaysSelectedEntryListWidget.Entry<ModEntry> {
        ...
        {
            String name = stripTextFormat(modInfo.getDisplayName());
            String version = stripTextFormat(MavenVersionStringHelper.artifactVersionToString(modInfo.getVersion()));
