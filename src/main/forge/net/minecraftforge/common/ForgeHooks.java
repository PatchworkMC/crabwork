...
public class ForgeHooks
{
    ...
    public static boolean canToolHarvestBlock(CollisionView world, BlockPos pos, @Nonnull ItemStack stack)
    {
    ...
    public static boolean isToolEffective(CollisionView world, BlockPos pos, @Nonnull ItemStack stack)
    {
        BlockState state = world.getBlockState(pos);
        //state = state.getActualState(world, pos);
    ...
    public static ActionResult onPlaceItemIntoWorld(@Nonnull ItemUsageContext context)
    {
        ...
        if (ret == ActionResult.SUCCESS)
        {
            ...
            if (itemstack.getTag() != null)
            {
                newNBT = itemstack.getTag().method_10553();
            }
