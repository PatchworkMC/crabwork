...
public interface IForgeBlock
{
    ...
    */
     ...
     */
    default boolean isPortalFrame(BlockState state, CollisionView world, BlockPos pos)
    {
    ...
    */
    ...
    default boolean isFireSource(BlockState state, BlockView world, BlockPos pos, Direction side)
    {
        ...
        if (getBlock() == Blocks.NETHERRACK || getBlock() == Blocks.MAGMA_BLOCK)
            return true;
        if (world instanceof CollisionView && ((CollisionView)world).getDimension() instanceof TheEndDimension && getBlock() == Blocks.BEDROCK)
            return true;
        return false;
    }
