...
public class FarmlandWaterManager
{
     ...
     */
    public static boolean hasBlockWaterTicket(CollisionView world, BlockPos pos)
    {
    ...
    private static ChunkTicketManager<Vec3d> getTicketManager(ChunkPos pos, CollisionView world) {
        Preconditions.checkArgument(!world.isClient(), "Water region is only determined server-side");
