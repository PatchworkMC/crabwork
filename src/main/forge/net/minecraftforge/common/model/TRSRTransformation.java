...
public final class TRSRTransformation implements IModelState, ITransformation
{
    ...
    {
        return transform.equals(Transformation.IDENTITY) ? identity : new TRSRTransformation(toVecmath(transform.translation), quatFromXYZDegrees(toVecmath(transform.rotation)), toVecmath(transform.scale), null);
    }
    ...
    @Deprecated
    @Environment(EnvType.CLIENT)
    public net.minecraft.client.render.model.json.Transformation toItemTransform()
    {
    ...
    @Environment(EnvType.CLIENT)
    public static Vector3f toVecmath(net.minecraft.client.util.math.Vector3f vec)
    {
        return new Vector3f(vec.x(), vec.y(), vec.z());
    }

    @Environment(EnvType.CLIENT)
    public static Vector4f toVecmath(net.minecraft.client.util.math.Vector4f vec)
    {
        return new Vector4f(vec.x(), vec.y(), vec.z(), vec.w());
    }

    @Environment(EnvType.CLIENT)
    public static Matrix4f toVecmath(net.minecraft.client.util.math.Matrix4f m)
    {
        return new Matrix4f(
    ...
    {
        return new Quat4f(q.getB(), q.getC(), q.getD(), q.getA());
    }

    @Environment(EnvType.CLIENT)
    public static net.minecraft.client.util.math.Vector3f toMojang(Vector3f vec)
    {
        return new net.minecraft.client.util.math.Vector3f(vec.x, vec.y, vec.z);
    }

    @Environment(EnvType.CLIENT)
    public static net.minecraft.client.util.math.Vector4f toMojang(Vector4f vec)
    {
        return new net.minecraft.client.util.math.Vector4f(vec.x, vec.y, vec.z, vec.w);
    }

    @Environment(EnvType.CLIENT)
    public static net.minecraft.client.util.math.Matrix4f toMojang(Matrix4f m)
    {
        net.minecraft.client.util.math.Matrix4f r = new net.minecraft.client.util.math.Matrix4f();
