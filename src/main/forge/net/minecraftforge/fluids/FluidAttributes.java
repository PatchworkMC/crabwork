...
public class FluidAttributes
{
    ...
    public Identifier getStill(FluidStack stack) { return getStillTexture(); }
    public Identifier getFlowing(FluidStack stack) { return getFlowingTexture(); }
    ...
    public Identifier getStill(BlockRenderView world, BlockPos pos) { return getStillTexture(); }
    public Identifier getFlowing(BlockRenderView world, BlockPos pos) { return getFlowingTexture(); }
