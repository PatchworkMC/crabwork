...
public abstract class ForgeFlowingFluid extends BaseFluid
{
    ...
    @Override
    protected int method_15733(CollisionView worldIn)
    {
        return slopeFindDistance;
    }

    @Override
    protected int getLevelDecreasePerBlock(CollisionView worldIn)
    {
    ...
    public static class Properties
    {
        ...
        private RenderLayer renderLayer = RenderLayer.TRANSLUCENT;
        ...
        public Properties renderLayer(RenderLayer layer)
        {
