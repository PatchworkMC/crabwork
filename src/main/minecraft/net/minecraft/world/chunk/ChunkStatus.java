...
public class ChunkStatus extends net.minecraftforge.registries.ForgeRegistryEntry<ChunkStatus> {
    ...
    @Shadow
    @Final
    private ChunkStatus parent;
    @Shadow
    @Final
    private ChunkStatus.IGenerationWorker generationWorker;
    @Shadow
    @Final
    private ChunkStatus.ILoadingWorker loadingWorker;
    @Shadow
    @Final
    private int taskRange;
    @Shadow
    @Final
    private ChunkStatus.Type type;
    @Shadow
    @Final
    private EnumSet<Heightmap.Type> heightmaps;
