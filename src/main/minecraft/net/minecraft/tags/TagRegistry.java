...
public class TagRegistry<T> {
    ...
    @Shadow
    @Final
    private List<TagRegistry.NamedTag<T>> tags;
    @Shadow
    @Final
    private Function<ITagCollectionSupplier, ITagCollection<T>> supplierToCollectionFunction;
    ...
    private static class OptionalNamedTag<T> extends NamedTag<T> implements net.minecraftforge.common.Tags.IOptionalNamedTag<T> {
        ...
        @Final
        @Nullable
        private Set<java.util.function.Supplier<T>> defaults;
        @Shadow
