...
public abstract class Entity extends net.minecraftforge.common.capabilities.CapabilityProvider<Entity> implements INameable, ICommandSource, net.minecraftforge.common.extensions.IForgeEntity {
	...
	@Shadow
	private final float nextStepDistance;

	@Shadow
	private final float nextFlap;
	...
	@Shadow
	private final Vector3d field_242272_av;

	@Shadow
	private final int field_242273_aw;
	...
	@Shadow
	private final boolean isPositionDirty;
	...
	@Shadow
	private final long pistonDeltasGameTime;
	...
	@Shadow
	private final Collection<ItemEntity> captureDrops;
	 ...
	 */
	@Shadow
	private final boolean isAddedToWorld;
