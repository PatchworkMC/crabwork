...
public class KeyBinding implements Comparable<KeyBinding>, net.minecraftforge.client.extensions.IForgeKeybinding {
    ...
    /****************** Forge Start *****************************/
    @Shadow
    private net.minecraftforge.client.settings.KeyModifier keyModifierDefault;
    @Shadow
    private net.minecraftforge.client.settings.KeyModifier keyModifier;
    @Shadow
    private net.minecraftforge.client.settings.IKeyConflictContext keyConflictContext;
