...
public class PackLoadingManager {
    @Shadow
    @Final
    private ResourcePackList field_241617_a_;
    @Shadow
    @Final
    private List<ResourcePackInfo> field_238860_a_;
    @Shadow
    @Final
    private List<ResourcePackInfo> field_238861_b_;
    @Shadow
    @Final
    private Function<ResourcePackInfo, ResourceLocation> field_243388_d;
    @Shadow
    @Final
    private Runnable field_238863_d_;
    @Shadow
    @Final
    private Consumer<ResourcePackList> field_238864_e_;
    ...
    abstract class AbstractPack implements PackLoadingManager.IPack {
        @Shadow
        @Final
        private ResourcePackInfo field_238878_b_;
