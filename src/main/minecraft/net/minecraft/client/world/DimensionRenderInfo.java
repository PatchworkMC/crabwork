...
public abstract class DimensionRenderInfo {
    ...
    @Shadow
    @Final
    private float[] field_239209_b_;
    @Shadow
    @Final
    private float field_239210_c_;
    @Shadow
    @Final
    private boolean field_239211_d_;
    @Shadow
    @Final
    private DimensionRenderInfo.FogType field_241680_e_;
    @Shadow
    @Final
    private boolean field_241681_f_;
    @Shadow
    @Final
    private boolean field_239212_e_;
    @Shadow
    private net.minecraftforge.client.IWeatherRenderHandler weatherRenderHandler;
    @Shadow
    private net.minecraftforge.client.ISkyRenderHandler skyRenderHandler;
    @Shadow
    private net.minecraftforge.client.ICloudRenderHandler cloudRenderHandler;
