...
public abstract class AbstractBlock extends net.minecraftforge.registries.ForgeRegistryEntry<Block> {
    ...
    public abstract static class AbstractBlockState extends StateHolder<Block, BlockState> {
        ...
        @Shadow
        @Final
        private AbstractBlock.IPositionPredicate isNormalCube;
        @Shadow
        @Final
        private AbstractBlock.IPositionPredicate blocksVisionChecker;
        @Shadow
        @Final
        private AbstractBlock.IPositionPredicate blocksVision;
        @Shadow
        @Final
        private AbstractBlock.IPositionPredicate needsPostProcessing;
        @Shadow
        @Final
    ...
    public static class Properties {
        ...
        private java.util.function.Supplier<ResourceLocation> lootTableSupplier;
        @Shadow
        private AbstractBlock.IExtendedPositionPredicate<EntityType<?>> allowsSpawn;
        @Shadow
        private AbstractBlock.IPositionPredicate isOpaque;
        @Shadow
        private AbstractBlock.IPositionPredicate suffocates;
        @Shadow
        private AbstractBlock.IPositionPredicate blocksVision;
        @Shadow
        private AbstractBlock.IPositionPredicate needsPostProcessing;
        @Shadow
        private AbstractBlock.IPositionPredicate emmissiveRendering;
        @Shadow
